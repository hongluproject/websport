...
class MCrypt
{
     ...
     * @return string
     */
    public static function base64_encrypt($data, $key) {
        $str = $char = null;
        $key = md5($key);
     ...
     * @return string
     */
    public static function base64_decrypt($data, $key) {
        $str = $char = null;
        $key = md5($key);
        $x = 0;
        $len = strlen($data);
     ...
     */
    public static function pplive_encrypt($str, $key) {
        $keylen = strlen($key);
        $length = strlen($str);
        $result = '';
        for ($i = 0; $i < $length; $i++) {
     ...
     * @return string $key  密钥
     */
    public static function pplive_decrypt($str, $key) {
        $keylen = strlen($key);
        $length = strlen($str);
        $result = '';
        for ($i = 0; $i < $length; $i++) {
     ...
     */
    public static function ppid_encode($input) {
        if (!$input)
            return '';
     ...
     * @return string			播放ID
     */
    public static function ppid_decode($input) {
        $id = '';
     ...
     * @return string
     */
    public static function base62_encode($value) {
     ...
     * @return string
     */
    public static function base62_decode($value) {
     ...
     * @return string $key  密钥
     */
    public static function pplive_encrypt2($str, $key) {
        $keylen = strlen($key);
        $length = strlen($str);
        $result = '';
        $byte = array();
     ...
     * @return string $key  密钥
     */
    public static function pplive_decrypt2($str, $key) {
        $keylen = strlen($key);
        $length = strlen($str);
        $result = '';
        $byte = array();
     ...
     * @return int
     */
    public static function char2byte($char) {
     ...
     * @return string
     */
    public static function byte2char($byte) {
        return pack('c', $byte);
    }
